...
def main_menu():
    ...
    button_play_offline = CustomButton(canvas_main_menu, text = "    PLAY OVER THE BOARD", image = img_play_offline, compound = TOP, font = ('Comic Sans', 18, 'bold'), bg = constant.PRIMARYCLR, fg = constant.LIGHTBGTEXTCLR, relief = "ridge", justify = "center", command = on_play_over_board)
    button_play_online = CustomButton(canvas_main_menu, text = "    PLAY A FRIEND ONLINE", image = img_play_online, compound = TOP,font = ('Comic Sans', 18, 'bold'), bg = constant.PRIMARYCLR, fg = constant.LIGHTBGTEXTCLR, relief = "ridge", justify = "center", command = on_play_with_friends)
    button_visit_past_games = CustomButton(canvas_main_menu, text = "    VISIT PAST GAMES    ", image = img_history, compound = TOP, font = ('Comic Sans', 18, 'bold'), bg = constant.PRIMARYCLR, fg = constant.LIGHTBGTEXTCLR, relief = "ridge", justify = "center", command = on_visit_past_games)
    button_about = CustomButton(canvas_main_menu, text = "ABOUT", font = ('Comic Sans', 12, 'bold'), bg = constant.DARKBGCLR, fg = constant.DARKBGTEXTCLR, bd = 0, highlightthickness = 0, relief = "ridge", command = on_about)
...
def settings():
    ...
    def on_choice_create_game():
        ...
        button_create_game = CustomButton(canvas_main_menu, text = "CREATE GAME", font = ('Comic Sans', 22, 'bold'), bg = constant.SECONDARYCLR, fg = constant.DARKBGTEXTCLR, relief = "ridge", justify = "center", command = on_create_game)
    ...
    def on_choice_join_game():
        ...
        button_join_game = CustomButton(canvas_main_menu, text = "JOIN GAME", font = ('Comic Sans', 22, 'bold'), bg = constant.SECONDARYCLR, fg = constant.DARKBGTEXTCLR, relief = "ridge", justify = "center", command = on_join_game)
    ...
    if mode_of_play == "offline":
        ...
        label_play_offline = Label(canvas_main_menu, text = "PLAY OVER THE\nBOARD", image = img_play_offline, compound = TOP, font = ('Comic Sans', 25, 'bold'), bg = constant.PRIMARYCLR, fg = constant.LIGHTBGTEXTCLR, justify = 'center')
        ...
        button_start_game = CustomButton(canvas_main_menu, text = "START GAME", font = ('Comic Sans', 22, 'bold'), bg = constant.SECONDARYCLR, fg = constant.DARKBGTEXTCLR, relief = "ridge", justify = "center", command = on_start_game)
        ...
        label_play_online = Label(canvas_main_menu, text = "PLAY A FRIEND\nONLINE", image = img_play_online, compound = TOP, font = ('Comic Sans', 25, 'bold'), bg = constant.PRIMARYCLR, fg = constant.LIGHTBGTEXTCLR, justify = 'center')
...
def on_draw(confirm = True):
    ...
    if confirm:
        if mode_of_play == "offline":
            ...
            requests.post(geturl('connection') , data= {'code':code, 'side':player_side, 'draw':'idk'})
            while 1:
                try :
                    r = requests.get(geturl('connection') , params= {'side' : player_side , 'code' : code , 'connectop':False})
                    time.sleep(0.2)
...
def about():
    ...
    Label(canvas_main_menu, text = "ABOUT        ", font = ('Comic Sans', 30, 'bold'), bg = constant.DARKBGCLR, fg = constant.DARKBGTEXTCLR, bd = 0, highlightthickness = 0).grid(row = 0, column = 1, sticky = NSEW)
...
def main():
    ...
    global wn, root_turtle, canvas_turtle, program_running, theme_bg, url, game_result, img_pocket_chess_arena_icon, draw_offer, max_board_size
    wn=turtle.Screen()
    wn.colormode(255)
    wn.bgcolor('black')
...
#    url = f'http://{ip}:{port}/'
    ...
    url = 'https://spice.alphagotreal.repl.co/'
    global geturl
