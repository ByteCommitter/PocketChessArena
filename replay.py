...
def games_played():
    ...
    label_title = Label(frame_top, text="GAMES PLAYED", font = ("Algerian", 25, 'bold', 'underline'), bg = constant.DARKBGCLR, fg = constant.DARKBGTEXTCLR)
    ...
    for individual_match_details in database_functions.receive_all_game_details():
        ...
        for i in individual_match_details[:-3]:                    
...
def define_basic_global_variables(match_no, list_of_moves, list_of_times, min_time_, increment_):
    ...
    #Initialising a chess for the chess board and a corresponding size for root_turtle
    length = 600
